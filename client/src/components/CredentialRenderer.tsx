    ...
    <div className="flex gap-4 items-start">
      {showPhoto && (
        <div className="h-20 w-16 rounded-xl overflow-hidden border-2 border-gray-200 shadow-md shrink-0">
          <img src={avatarUrl} alt="" className="h-full w-full object-cover" loading="eager" crossOrigin="anonymous" onError={(e) => { (e.target as HTMLImageElement).style.opacity = '0'; }} />
        </div>
      )}
...
function PractitionerSection({ practitioner, role }: { practitioner: any; role?: string }) {
  ...
  return (
    <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 rounded-xl p-4">
      <img src={practitionerAvatar} alt="" className="h-12 w-12 rounded-full object-cover border-2 border-white shadow-sm" loading="eager" crossOrigin="anonymous" onError={(e) => { (e.target as HTMLImageElement).style.opacity = '0'; }} />
      <div>
