...
const allMenuItems: MenuItemDef[] = [
  ...
  { id: "notifications", label: "แจ้งเตือน", icon: "Bell", path: "/notifications", roles: ["system_admin", "hospital_admin", "doctor", "nurse", "patient", "maker", "checker", "integration_engineer"], group: "service_readiness", groupLabel: "ความพร้อมก่อนรับบริการ" },
